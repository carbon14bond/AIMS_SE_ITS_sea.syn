...
setwd("/Users/kuehnlab/combined_ITS_FULL")
```
...
```{r, set path}
path <- "/Users/kuehnlab/combined_ITS_FULL/fastq"
list.files(path)
```
...
sample.names <- sapply(str_replace(sample.names, "XBOND_", ""),`[`, 1)
